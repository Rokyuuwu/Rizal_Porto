...
gsap.from('.game img', {scrollTrigger:'.game img', opacity: 0, duration: 1, delay: 1.1, x: -100}) 
gsap.from('.game p', {scrollTrigger:'.game p', opacity: 0, duration: 0.7, delay: 1, x: 30}) 
